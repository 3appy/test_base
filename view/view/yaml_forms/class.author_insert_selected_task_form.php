...
/**
 * untitledModel - class.author_insert_selected_task_form.php
 *
 * $Id$
 *
 * This file is part of untitledModel.
 *
 * Automatically generated on 25.01.2017, 10:49:05 with ArgoUML PHP module 
...
// section 10-30--16-64-2db09b41:159ac94cdbb:-8000:0000000000000E12-includes begin
// section 10-30--16-64-2db09b41:159ac94cdbb:-8000:0000000000000E12-includes end

/* user defined constants */
// section 10-30--16-64-2db09b41:159ac94cdbb:-8000:0000000000000E12-constants begin
// section 10-30--16-64-2db09b41:159ac94cdbb:-8000:0000000000000E12-constants end

/**
 * Short description of class author_insert_selected_task_form
 *
 * @access public
 * @author firstname and lastname of author, <author@example.org>
 */
class author_insert_selected_task_form
    extends standard_form
{
    ...
    public function get_element_list()
    {
     ...
     $status_button->set_name($this->language['all_pupils']);
     ...
     $check_list = new fbox_check_pupil_list();
     $check_list->set_language( $this->language );
     $check_list->set_name("checked[]");
     $check_list->set_pupil_list( $this->pupil_list );
     $check_list->define_model();
