...
// section 10-30-49-93-1ce7cdec:144734efde7:-8000:0000000000000AD7-includes begin
// section 10-30-49-93-1ce7cdec:144734efde7:-8000:0000000000000AD7-includes end

/* user defined constants */
// section 10-30-49-93-1ce7cdec:144734efde7:-8000:0000000000000AD7-constants begin
// section 10-30-49-93-1ce7cdec:144734efde7:-8000:0000000000000AD7-constants end
    ...
    extends func_standard_table_presentation
{
    ...
    public function define_table_element()
    {
     ...
     $event = $this->get_list_model();
     $address = $event->get_address();
     $country = $address->get_country_id();
     $private_information = $event->get_private_information();
     ...
     $line->add_item( $event->get_name() );
     $this->get_table_element_list()->add_item( $line );
     
     $line = new basic_list();
     $line->add_item( $language['C3_event_day'] );
     $line->add_item( $event->get_day() . "-" .
     $event->get_month() . "-" .
     $event->get_year() );
     $this->get_table_element_list()->add_item( $line );
