    ...
    extends basic_control
{
    ...
    public function perform()
    {
     ...
     case ( 24 ):
     // school_connection
     $this->school_connection();
     break;
     
     case ( 25 ):
     // export CSV
     $this->show_export_csv();
     break;
     ...
     * @author firstname and lastname of author, <author@example.org>
     */
    public function school_connection()
    {
     //24 school_connection
     $this->next_frame = $_SESSION['C_frame_base'] . "C24_frame.php";
    }
    /**
     *
     * @access public
     * @author firstname and lastname of author, <author@example.org>
     */
    public function show_export_csv()
    {
     //25 export csv
     $this->next_frame = $_SESSION['C_frame_base'] . "C25_frame.php";
    }
    /**
     *
     * @access public
