 ...
 *
 * Automatically generated on 05.03.2017, 08:34:33 with ArgoUML PHP module 
    ...
    extends C27_post_control
{
    ...
    public function handle_csv_line($csv_line)
    {
     ...
     $success = FALSE;
     $parent_mail = $csv_line->get_item( (int)0 );
     $pupil_mail = $csv_line->get_item( (int)1 );
     
     $service = new service_new_member();
     // find the parent ....
     $service->set_mail_address( $parent_mail );
     ...
     // find the pupil ....
     $service->set_mail_address( $pupil_mail );
     if( $service->member_exist() )
     ...
     $success =
     $scon->set_member_follower_connection_csv( $follower_id );
     }
     return $success;
    }
}?>