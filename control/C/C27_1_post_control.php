 ...
 *
 * Automatically generated on 01.03.2017, 15:33:18 with ArgoUML PHP module 
    ...
    extends C27_post_control
{
    ...
    public function handle_csv_line($csv_line)
    {
     ...
     $team_list->set_owner_id( $this->get_top_team()->get_network_id() );
