    ...
    extends basic_member_list
{
    ...
    public function is_level_3($member)
    {
     ...
     $status = $con->get_con_status( $this->get_id(), $member->get_id() );
    ...
    public function is_level_4($member)
    {
     ...
     $level = FALSE;
     $con = new member_follower();
     $status = $con->get_con_status( $member->get_id(), $this->get_id() );
    ...
    public function is_level_5($member)
    {
     ...
     $level = FALSE;
     $con = new member_follower();
     $status1 = $con->get_con_status( $member->get_id(), $this->get_id() );
     $status2 = $con->get_con_status( $this->get_id(), $member->get_id() );

     if(( $status1 == (int)5 ) OR ( $status2 == (int)5 ))
     { $level = TRUE; }
     return $level;
    }
    /**
