 ...
 *
 * Automatically generated on 16.02.2017, 21:38:53 with ArgoUML PHP module 
    ...
    extends generated_team
{
     ...
     * @author firstname and lastname of author, <author@example.org>
     */
    public function get_recursive_subteam_list()
    {
     
     $team_list = $this->get_subteam_list();
     $count = $team_list->get_item_count();
     for( $n=0; $n<$count; $n++ )
     {
     $team = $team_list->get_item( $n );
     $sub_team_list = $team->get_recursive_subteam_list();
     if( $sub_team_list->get_item_count() > (int)0 )
     ...
     * @author firstname and lastname of author, <author@example.org>
     */
    public function get_school_room_list()
    {
     require_once('class.room_list.php');
     
     $room_list = new room_list();
     $room_list->set_owner_id( $this->get_network_id() );
     $room_list->load_school_room();
     return $room_list;
    }
    /**
     *
    ...
    public function get_control_table_item_list()
    {
     ...
     $time_table_list = new control_time_table_item_list();
     $time_table_list->set_owner_id( $this->get_id() );
     $time_table_list->load();
