 ...
 *
 * Automatically generated on 17.02.2017, 15:14:05 with ArgoUML PHP module 
    ...
    extends team_navigation
{
     ...
     * @access public
     * @author firstname and lastname of author, <author@example.org>
     * @param  new_control_table_item
     */
    public function exist_control_table_item($new_control_table_item)
    {
     $exist = FALSE;
     // exist this new control_table_item ?
     $table_control_list = $this->get_control_table_item_list();
     $count = $table_control_list->get_item_count();
     for ( $n=0; (($n<$count) AND ($exist == FALSE)); $n++ )
     {
     $control_table_item = $table_control_list->get_item( $n );
     if
     (( $control_table_item->get_day_number() ==
     $new_control_table_item->get_day_number() )
     AND 
     ( $control_table_item->get_time_number() ==
     $new_control_table_item->get_day_number() ))
     { $exist = TRUE; }
     }
    }
