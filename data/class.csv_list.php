 ...
 *
 * Automatically generated on 02.03.2017, 11:13:53 with ArgoUML PHP module 
    ...
    extends generated_csv_list
{
    ...
    public function load_csv_list_from_text($csv_content)
    {
     ...
     $line_list->set_array( explode( $this->seperator, $csv_line ) );
    ...
    public function get_csv_text()
    {
     ...
     {
     $csv_line = $this->get_item($c)->implode();
    ...
    {
     return implode( $this->seperator, $this->get_array() );
    }
}?>